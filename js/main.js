...
function renderCharacters(characters){
  ...
  characters.forEach(c=>{
    ...
    card.innerHTML = `
      ${ c.img ? `<div class="full-portrait-wrap${c.name !== 'Charlie' ? ' teaser' : ''}"${ c.imgScale ? ` style="--portrait-scale:${c.imgScale}"` : '' }><img class="full-portrait" src="${c.img}" alt="${c.name}" draggable="false"></div>` : '' }
      <div class="text-col">
